...
public class Niveau extends JFrame  {
        ...
        String ch ="";
        JLabel motLabel;
        private int nbEssais = 6;
        boolean lettresDevinees [];
        JLabel labelInsert;
        private String[] Mots;
    ...
    public Niveau (String niveau)
    {
        ...
        NomJoueur = new JLabel(BaseDeDonnee.getNomUtilisateurConnecte());
        ...
        {
            Mots = new String[]  {"JAVA","PROGRAMME","VARIABLE","OBJET","CLASSE","INTERFACE","TABLEAU","BOUCLE","CONDITION","METHODE","HERITAGE","POLYMORPHISME","ENCAPSULATION","EXCEPTION","THREAD"};
        }

        else if (niveau.equals("normale"))
        {
            Mots = new String[] {"SWING","APPLET","DIALOGUE","LAMBDA","ANONYME","INTERNE","MEMBRE","ARRAYLIST","RANDOM","PANEL","LAYOUT","SUPER","FRAME","COLLECTION","ITERATOR","THROW"};
        }

        else
        {
            Mots = new String[] {"FLOWLAYOUT","ACTIONLISTENER","ECOUTEUR","SCANNER","IMAGEICON","BUTTON","COMBOBOX","CHECKBOX","WINDOW","ECLIPCE","STATIC","GRIDLAYOUT","BOUNDS","SETTEXT","ICON"};
        }
        ...
        motLabel = new JLabel();
        motLabel.setFont(new Font(Font.SERIF, Font.BOLD, 20));
        ...
        for(char c = 'A'; c <= 'Z'; c++) {
            ...
            button.addActionListener(new ActionListener() {
                public void actionPerformed (ActionEvent e)      
                {
                    ...
                    if (motComplet()) {
                        dispose();
                        Utilisateur utilisateur = BaseDeDonnee.getUtilisateur();
